...
namespace Day2Homework1DataTypesJune
{
    class Day2Homework1DataTypesJune
    {
        static void Main(string[] args)
        {
            /*
                         Data Type Example Default Value Memory Size                    Classification
            ...
            */
            /*
             C# Shorthand CLS Compliant? System Type    Range Meaning                                                   in Life
                ...
                float       Yes         System.Single   -3.4 1038 to +3.4 1038                                      32-bit floating-point number
                double      Yes         System.Double   ±5.0 10–324 to ±1.7 10308                                   64-bit floating-point number
                decimal     Yes         System.Decimal  (-7.9 x 1028 to 7.9 x 1028)/(100 to 28)                     128-bit signed number
